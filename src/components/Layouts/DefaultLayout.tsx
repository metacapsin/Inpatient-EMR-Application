    ...
    return (
        <App>
            ...
            <div className="relative">
                ...
                {/* screen loader */}
                {showLoader && (
                    <div className="screen_loader fixed inset-0 bg-[#f8f6f4] dark:bg-[#0f0d0b] z-[60] grid place-content-center animate__animated">
                        <svg width="64" height="64" viewBox="0 0 135 135" xmlns="http://www.w3.org/2000/svg" fill="#97704f">
