...
export type PainResponseToIntervention = '' | 'Complete Relief' | 'Partial Relief' | 'No Relief';
...
export interface PainSection {
    ...
    /** Mirrors Risk Assessments → Pain Assessment tab. */
    responseToIntervention: PainResponseToIntervention;
    reassessmentPriority: 'STAT' | 'routine';
    reassessmentDue: Date | null;
}

export const DEFAULT_PAIN_SECTION: PainSection = {
    intensity0to10: null,
    location: '',
    quality: [],
    radiation: false,
